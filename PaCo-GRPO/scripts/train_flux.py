...
from paco_grpo.utils import tensor_list_to_pil_image, tensor_to_pil_image, all_gather_tensor_list, divide_prompt, divide_latents, merge_latents, num_to_base_tuple, create_generator
from paco_grpo.rewards.rewards import multi_score
from paco_grpo.diffusers_patch.flux_pipeline import calculate_shift, flux_pipeline, compute_log_prob
from paco_grpo.ema import EMAModuleWrapper
from paco_grpo.stat_tracking import PerPromptStatTracker
from paco_grpo.data_utils.prompt_dataset import TextPromptDataset, GenevalPromptDataset
from paco_grpo.data_utils.sampler import DistributedGroupKRepeatSampler, DistributedKRepeatSampler
            ...
            for i, sample in tqdm(
                ...
                for j in tqdm(
                    ...
                    with accelerator.accumulate(transformer):
                        # For PPO and Guard-GRPO, the forward pass will be computed again, which is less efficient than the original code in FlowGRPO.

...
from editscore import EditScore, ConsistencyScore
...
def parse_args():
    ...
    parser.add_argument("--scorer", type=str, default="EditScore")
    return parser.parse_args()


def main(args):
    start_time = time.time()
    scorer_cls = EditScore if args.scorer == "EditScore" else ConsistencyScore
    scorer = scorer_cls(

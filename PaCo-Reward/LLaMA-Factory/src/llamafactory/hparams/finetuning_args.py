...
class FinetuningArguments(
    ...
    first_token_accuracy: bool = field(
        default=False,
        metadata={"help": "Whether or not to compute the first token accuracy at evaluation."},
    )
    first_token_weight: Optional[float] = field(
        default=None,
        metadata={"help": "The weight for the first token loss in sft training."},
    )
